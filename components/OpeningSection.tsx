      ...
      >
        <div className="oval-container animate-float-subtle">
          ...
          <motion.p 
            ...
            className="font-[family-name:var(--font-smoky)] text-xl md:text-2xl text-[#5A5A40] mb-2"
          >
            The Wedding of
          </motion.p>
          ...
          <motion.p 
            variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5 } } }}
            className="font-[family-name:var(--font-smoky)] text-xl md:text-2xl text-[#5A5A40] mt-2"
          >
            August 2026
          </motion.p>
        </motion.div>
