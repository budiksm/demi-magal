        ...
        <div className="relative z-20 px-10 py-12">
          ...
          >
            ...
            <motion.p
              ...
              className="font-[family-name:var(--font-beth-ellen)] text-5xl text-olive/50 leading-none mb-1 -mt-2"
            >
              "
            </motion.p>
            ...
            {[
              ...
              <motion.p
                ...
                className="font-[family-name:var(--font-beth-ellen)] text-base text-burgundy leading-relaxed"
              >
                {line}
              </motion.p>
            ))}
            ...
            <motion.p
              ...
              className="font-[family-name:var(--font-beth-ellen)] text-sm text-olive mt-4"
            >
              (QS. Ar-Rum : 21)
            </motion.p>
          </motion.div>
